    ...
    >
      ...
      >
        ...
        <Stack direction="row" spacing={0.5} alignItems="center">
          <Tooltip title="Previous lesson" arrow>
            <span>
              <IconButton
                size="small"
                ...
                sx={{
                  color: hasPrevLesson ? 'text.secondary' : 'text.disabled',
          ...
          <Tooltip title="Next lesson" arrow>
            <span>
              <IconButton
                size="small"
                ...
                sx={{
                  color: hasNextLesson ? 'text.secondary' : 'text.disabled',
                  '&:hover': { bgcolor: alpha(theme.palette.primary.main, 0.08) }
                }}
              >
        ...
        <Stack direction="row" spacing={1.5} alignItems="center">
          ...
          {!isCompleted ? (
            <Button
              ...
              startIcon={<IconCircleCheck size={18} strokeWidth={2} />}
              sx={{
                bgcolor: '#22c55e',
                color: '#fff',
                fontWeight: 600,
                ...
                '&:hover': {
                  bgcolor: '#16a34a',
                  boxShadow: `0 4px 12px ${alpha('#22c55e', 0.4)}`
                }
              }}
            >
              Mark Complete
          ...
          {hasQuiz && (
            <Button
              variant="contained"
              onClick={onStartQuiz}
              startIcon={<IconHelpCircle size={18} strokeWidth={2} />}
              sx={{
          ...
          <Box sx={{ display: 'flex', gap: 0.5, ml: 1 }}>
            ...
            <Tooltip title="Share lesson" arrow>
              <IconButton
                size="small"
                sx={{
      ...
      >
        <Button
          variant="text"
          startIcon={<IconChevronLeft size={20} strokeWidth={2} />}
          onClick={onPrevLesson}
          disabled={!hasPrevLesson}
          sx={{
            fontWeight: 600,
            fontSize: '0.875rem',
            color: hasPrevLesson ? 'text.primary' : 'text.disabled',
            textTransform: 'none',
            px: 2,
            '&:hover': {
              bgcolor: alpha(theme.palette.primary.main, 0.08)
        ...
        <Button
          variant="text"
          endIcon={<IconChevronRight size={20} strokeWidth={2} />}
          onClick={onNextLesson}
          disabled={!hasNextLesson}
          sx={{
            fontWeight: 600,
            fontSize: '0.875rem',
            color: hasNextLesson ? 'text.primary' : 'text.disabled',
            textTransform: 'none',
            px: 2,
            '&:hover': {
              bgcolor: alpha(theme.palette.primary.main, 0.08)
