...
const NavCollapse: FC<NavCollapseProps> = ({ menu, level, parentId }) => {
  ...
  const menuIcon = menu.icon ? (
    <Icon stroke={1.5} size="1.3rem" style={{ marginTop: 'auto', marginBottom: 'auto' }} />
  ) : (
  ...
  let menuIconClass = !menu.icon ? { marginTop: 'auto', marginBottom: 'auto' } : {};
  ...
  // menu collapse for sub-menu list
  return (
    <>
      <ListItemButton
        ref={ref}
        ...
        onClick={handleClick}
      >
        <ListItemIcon sx={{ my: 'auto', minWidth: !menu.icon ? 18 : 36, ...menuIconClass }}>
          {menuIcon}
        </ListItemIcon>
        <ListItemText
          primary={
